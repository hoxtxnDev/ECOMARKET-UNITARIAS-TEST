 ...
 *
 * Estrategia: RuntimeException y DataIntegrityViolationException SÍ tienen
 * un disparador natural (el service lanzándolas a través de un endpoint real
 * de PagoController), así que se prueban con MockMvc.
 *
 ...
 *
 * Ejecutar:
 *   mvn test -pl proceso-pago-service -Dtest=GlobalExceptionHandlerTest
 */
